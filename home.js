  ...
  <div class="relative h-[90vh] md:h-screen min-h-[600px] overflow-hidden bg-black">
    ...
    <div class="relative z-10 flex h-[70%] flex-col items-center justify-center px-4 md:px-6">
      <div class="w-full text-center">
        ...
        <h1 class="text-7xl sm:text-8xl md:text-[12vw] leading-[0.85] font-bold tracking-tighter text-white drop-shadow-2xl uppercase animate-reveal">
          TRAVEL
        </h1>
        <h1 class="text-7xl sm:text-8xl md:text-[12vw] leading-[0.85] font-bold tracking-tighter text-white drop-shadow-2xl uppercase animate-reveal delay-200">
          INDIA
        </h1>
